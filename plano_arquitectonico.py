...
# --- BASE DE DATOS GEOMÉTRICA DE ÁREAS CORREGIDA (X: Frente, Y: Fondo, Z: Centro y dx, dy, dz para go.Box) ---
zonas_3d = [
    {"name": "Zona de Dispensación y Atención", "x": 4.0, "y": 1.25, "z": 0.5, "dx": 8.0, "dy": 2.5, "dz": 1.0, "area": 20, "color": "#a2d149", "desc": "Área comercial frontal orientada al usuario presencial."},
    {"name": "Bodega de Almacenamiento General", "x": 2.0, "y": 4.375, "z": 0.5, "dx": 4.0, "dy": 3.75, "dz": 1.0, "area": 15, "color": "#fcd12a", "desc": "Custodia técnica de stock mayorista (30-45 días de inventario)."},
    {"name": "Módulo de Consulta Farmacéutica (QF)", "x": 6.0, "y": 3.5, "z": 0.5, "dx": 4.0, "dy": 2.0, "dz": 1.0, "area": 8, "color": "#3498db", "desc": "Módulo privado para programas de lealtad y seguimiento a pacientes crónicos."},
    {"name": "Nodo Logístico de Alistamiento", "x": 6.0, "y": 5.5, "z": 0.5, "dx": 4.0, "dy": 2.0, "dz": 1.0, "area": 8, "color": "#bb8fce", "desc": "Centro de picking, empaque y despacho de pedidos omnicanal por WhatsApp."},
    {"name": "Área Administrativa y Control Central", "x": 1.2, "y": 7.5, "z": 0.5, "dx": 2.4, "dy": 2.5, "dz": 1.0, "area": 6, "color": "#b2babb", "desc": "Oficina administrativa y servidores de control central ERP."},
    {"name": "Cuarto de Cadena de Frío", "x": 3.6, "y": 7.5, "z": 0.5, "dx": 2.4, "dy": 2.5, "dz": 1.0, "area": 6, "color": "#5dedec", "desc": "Aislamiento térmico para la custodia de medicamentos termolábiles."},
    {"name": "Bahía de Recepción y Cuarentena", "x": 5.8, "y": 7.5, "z": 0.5, "dx": 2.4, "dy": 2.5, "dz": 1.0, "area": 5, "color": "#d4efdf", "desc": "Área técnica de descargue y muestreo organoléptico de lotes nuevos."},
    {"name": "Unidad de Bioseguridad y Punto Azul", "x": 7.4, "y": 8.16, "z": 0.5, "dx": 1.2, "dy": 3.33, "dz": 1.0, "area": 4, "color": "#ec7063", "desc": "Depósito de residuos hospitalarios peligrosos y punto ecológico posconsumo."},
    {"name": "Servicios Sanitarios y Vestier", "x": 0.8, "y": 10.0, "z": 0.5, "dx": 1.6, "dy": 2.5, "dz": 1.0, "area": 4, "color": "#f5cba7", "desc": "Higiene y bienestar físico para el personal operativo (BPA)."},
    {"name": "Corredores y Circulación Interna", "x": 4.2, "y": 9.14, "z": 0.025, "dx": 5.2, "dy": 0.78, "dz": 0.05, "area": 4, "color": "#d5f5e3", "desc": "Pasillos demarcados para tránsito seguro de personal y carros de carga."},
    {"name": "Bahía Externa de Parqueo y Carga Logística", "x": 4.0, "y": 12.375, "z": 0.01, "dx": 8.0, "dy": 2.25, "dz": 0.02, "area": 18, "color": "#707b7c", "desc": "Zona exterior pavimentada para clientes y estacionamiento de motocicletas de domicilios."}
]

# --- BASE DE DATOS DE MOBILIARIO REALISTA EN 3D SÓLIDO (CUBOS OPERATIVOS REAIS) ---
mobiliario_3d = [
    {"name": "🛋️ Mostrador Ergonómico POS Principal", "x": 4.0, "y": 1.3, "z": 0.55, "dx": 6.0, "dy": 0.6, "dz": 1.1, "color": "#ffffff", "desc": "Mesa de dispensación lineal que alberga las 3 cajas registradoras."},
    {"name": "🛋️ Estantería Modular Pesada - Módulo A", "x": 0.5, "y": 4.3, "z": 1.1, "dx": 0.6, "dy": 3.0, "dz": 2.2, "color": "#34495e", "desc": "Góndola metálica industrial para almacenamiento de medicamentos OTC."},
    {"name": "🛋️ Estantería Modular Pesada - Módulo B", "x": 1.7, "y": 4.3, "z": 1.1, "dx": 0.6, "dy": 3.0, "dz": 2.2, "color": "#34495e", "desc": "Góndola metálica industrial para medicamentos de prescripción crónica (SOM)."},
    {"name": "🛋️ Escritorio de Consulta Clínica QF", "x": 6.0, "y": 3.5, "z": 0.4, "dx": 2.0, "dy": 1.0, "dz": 0.8, "color": "#eaecee", "desc": "Módulo administrativo del Regente para atención personalizada."},
    {"name": "🛋️ Mesa Técnica de Alistamiento y Despacho", "x": 6.0, "y": 5.5, "z": 0.45, "dx": 2.0, "dy": 1.0, "dz": 0.9, "color": "#ebf5fb", "desc": "Superficie de embalaje, etiquetado y picking omnicanal."},
    {"name": "🛋️ Refrigerador Clínico Horizontal No. 1", "x": 3.0, "y": 7.5, "z": 0.6, "dx": 0.8, "dy": 1.8, "dz": 1.2, "color": "#ffffff", "desc": "Nevera de alta precisión con termohigrómetro integrado para insulinas."},
    {"name": "🛋️ Refrigerador Clínico Horizontal No. 2", "x": 4.2, "y": 7.5, "z": 0.6, "dx": 0.8, "dy": 1.8, "dz": 1.2, "color": "#ffffff", "desc": "Nevera de alta precisión para custodia estable de biológicos y vacunas."},
    {"name": "🛋️ Mesa de Inspección de Acero Inoxidable", "x": 5.8, "y": 7.1, "z": 0.45, "dx": 1.6, "dy": 1.0, "dz": 0.9, "color": "#bdc3c7", "desc": "Superficie aséptica para la validación y muestreo de lotes mayoristas."},
    {"name": "🛋️ Estiba de Madera Regulada (Cuarentena)", "x": 5.8, "y": 8.2, "z": 0.075, "dx": 1.6, "dy": 0.8, "dz": 0.15, "color": "#ba4a00", "desc": "Plataforma de aislamiento del suelo exigida por las Buenas Prácticas (BPA)."},
    {"name": "🛋️ Módulo de Depósito y Contenedor Punto Azul", "x": 7.4, "y": 7.5, "z": 0.7, "dx": 0.8, "dy": 1.0, "dz": 1.4, "color": "#f1c40f", "desc": "Contenedor de recolección selectiva posconsumo autorizado por la Resolución 0371 de 2009."},
    {"name": "🚗 Celda Parqueo Clientes Particulares", "x": 2.25, "y": 12.375, "z": 0.025, "dx": 2.5, "dy": 0.1, "dz": 0.05, "color": "#ffffff", "desc": "Espacio delimitado para el estacionamiento temporal de usuarios del Mall La 33."},
    {"name": "🛵 Bahía Técnica Flota de Domicilios FarmaTech", "x": 5.75, "y": 12.375, "z": 0.025, "dx": 2.5, "dy": 0.1, "dz": 0.05, "color": "#ffffff", "desc": "Zona exclusiva reservada para el cargue seguro y estacionamiento de las 3 motocicletas."}
]
...
# 1. Capa Arquitectónica: Cuartos técnicos (Sólidos - Altura de Maqueta 1.0m usando go.Box)
if mostrar_cuartos:
    for z in zonas_3d:
        html_zona = f"<b>{z['name']}</b><br>Área: {z['area']} m²<br>Estructura: Altura de Maqueta 1.0m<br>{z['desc']}"
        # Si es la bahía de parqueo externa, la dejamos bien plana en el suelo con dz bajo
        dz_val = 0.02 if "Parqueo" in z["name"] else z["dz"]
        fig.add_trace(go.Box(
            x=[z["x"]], y=[z["y"]], z=[z["z"]],
            dx=z["dx"], dy=z["dy"], dz=dz_val,
            color=z["color"], opacity=0.45, name=z["name"],
            text=html_zona, hoverinfo="text"
        ))

# 2. Capa Industrial: Mobiliario y Maquinaria (Sólidos - Opacidad Total usando go.Box)
if mostrar_muebles:
