...
zonas_3d = [
    ...
    {"name": "Cuarto de Cadena de Frío", "x_range": [2.4, 4.8], "y_range": [6.25, 8.75], "z_range": [0, 1.0], "area": 6, "color": "#5dedec", "desc": "Aisolation térmica para la custodia de medicamentos termolábiles."},
