...
st.markdown('<h1 claimport streamlit as st
import pandas as pd
import numpy as np
import plotly.graph_objects as go
import plotly.express as px
...
# 1. BASE DE DATOS ESTRUCTURAL (Tabla 11 Oficial con valor de Arriendo corregido)
data_opex = {
    "Rubro Técnico": [
...
col_visual1, col_visual2 = st.columns()
...
ss="main-title">🚀 FarmaTech Ltda. — Centro de Control Analítico Avanzado</h1>', unsafe_allow_html=True)
st.caption("Simulación Cuántica de Sensibilidad y Modelado de Costos Fijos Estructurales (OPEX 2026)")
st.markdown("---")
